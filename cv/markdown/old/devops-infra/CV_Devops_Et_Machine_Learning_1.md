Romeo CAVAZZA
Alternance — DevOps & Machine Learning

Étudiant en Master Cloud, je souhaite rapprocher MLOps, automatisation et infrastructure afin de fiabiliser le déploiement de solutions data et IA.
...
MLOps & IA
PyTorch, scikit-learn, LangChain, OpenAI API, Ollama
Infrastructure (IaC)
NixOS, Ansible, Docker, Linux, Git
Observabilité & Data
Grafana, Prometheus, Loki, PostgreSQL, InfluxDB
CI/CD & sécurité
GitHub Actions, GitLab, Jenkins, SOPS, Valgrind
