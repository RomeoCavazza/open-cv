Romeo CAVAZZA
Alternance — Ingénieur Data & FinOps

Étudiant en Master Cloud, je souhaite contribuer à des plateformes data efficientes et maîtrisées en coûts, en combinant pipelines Python, observabilité et bonnes pratiques d'infrastructure.
...
Pré-MSc — Python, APIs, SQL, Docker, Linux et automatisation
HarvardX, edX
...
Cloud & FinOps
AWS, Docker, Linux, NixOS, GitHub Actions
Data
Python, SQL, PostgreSQL, InfluxDB, Grafana
Backend
FastAPI, Flask, REST, Redis, Alembic
Observabilité
Grafana, Prometheus, Loki, PostgreSQL, Redis
Automation
Bash, Git, Docker, NixOS, Python
