...
Étudiant en Master Big Data, je souhaite contribuer à la modernisation de pipelines de données vers des architectures plus temps réel, robustes et observables.
...
Pré-MSc — Python, SQL, APIs, Docker et bases d'ingénierie data
HarvardX, edX
...
IA & Recherche
pandas, scikit-learn, OpenAI API, Qdrant, pgvector
Observabilité
Grafana, Prometheus, Loki, Redis, PostgreSQL
DevOps
Docker, Linux, Git, GitHub Actions, NixOS
