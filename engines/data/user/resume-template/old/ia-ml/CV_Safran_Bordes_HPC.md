Romeo CAVAZZA
Alternance — Informatique Scientifique & Calcul Haute Performance

Étudiant en Master Big Data et attiré par le calcul scientifique, je souhaite contribuer aux environnements HPC et outils de simulation de Safran Helicopter Engines.
...
Pré-MSc — Python, Linux, algorithmique, SQL et outillage scientifique
HarvardX, edX
...
Python, Bash, C, C++, SQL
Calcul scientifique
NumPy, SciPy, Jupyter, CUDA, Linux
Data & instrumentation
InfluxDB, Grafana, Arduino, pyserial, UART
Infrastructure
Docker, NixOS, Git, GitHub Actions, Systemd
Outils & qualité
CMake, GDB, Valgrind, Grafana, PostgreSQL
