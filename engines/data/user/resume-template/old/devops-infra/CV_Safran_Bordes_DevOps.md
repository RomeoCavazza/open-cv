Romeo CAVAZZA
Alternance — Ingénieur DevOps

Étudiant en Master Cloud et admiratif de l'excellence industrielle de Safran, je souhaite mettre mes compétences Linux, NixOS et GitOps au service de la souveraineté technologique française.
...
Pré-MSc — Python, APIs, Java OOP et GitOps
HarvardX, edX
...
Langages
Python, Bash, Rust, C, SQL, Lua
Observabilité & Data
Grafana, Prometheus, Loki, InfluxDB, Elasticsearch
Infrastructure (IaC)
NixOS (Flakes), Ansible, Terraform, Kubernetes, Helm
CI/CD
GitHub Actions, GitLab CI, Jenkins, Docker, Git
Hardening
systemd, SOPS, GitGuardian, GDB, Valgrind
