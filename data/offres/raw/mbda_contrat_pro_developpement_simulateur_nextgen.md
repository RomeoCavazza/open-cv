...
**Titre de la liste :** MBDA - Contrat Pro Développement simulateur NextGen
**URL:** [https://www.mbda-systems.com/country-fr/careers/contrat-pro-ingenieur-developpement-simulateur-nextgen-fh](https://www.mbda-systems.com/country-fr/careers/contrat-pro-ingenieur-developpement-simulateur-nextgen-fh)
**URL source utilisée pour le scraping:** [https://www.mbda-systems.com/country-fr/careers/contrat-pro-ingenieur-developpement-simulateur-nextgen-fh](https://www.mbda-systems.com/country-fr/careers/contrat-pro-ingenieur-developpement-simulateur-nextgen-fh)
**Date de récupération:** 2026-04-25T02:03:47+02:00
**HTTP status:** 200
...
Le Plessis-Robinson (92)
 ...
 [Postuler](https://mbda.gestmax.fr/apply/18705/1/contrat-pro-ingenieur-developpement-simulateur-nextgen-f-h)
...
Contribuer au développement d’une nouvelle ligne de produits pour les simulateurs nouvelle génération.

## Votre quotidien

**Grâce à vos compétences, vous :**

- Participez à la rédaction d’un dossier de conception logicielle ;
- Développez une première implémentation ainsi que des prototypes basés sur l’architecture définie ;
- Réalisez les tests et la validation de vos développements ;
- Intégrez vos travaux au sein de la solution globale.
...
Prochainement en troisième année d'un cycle ingénieur ou équivalent avec une spécialité en Informatique Industrielle et/ou Logiciel.

Vous possédez des premières connaissances en langage Go, des notions d’UML ainsi qu'une appétence pour la conception logicielle.
...
**Type de contrat :** contrat de professionnalisation (frais de formation à la charge de l'entreprise/école)
