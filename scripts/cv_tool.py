...
from paths import INSTANCES_ROOT, OFFERS_ROOT, PROJECT_ROOT, TEMPLATES_ROOT, WEB_ROOT
...
def command_init(job_id: str, force: bool = False):
    root = PROJECT_ROOT
    instances_dir = INSTANCES_ROOT / job_id
    templates_dir = TEMPLATES_ROOT
    
    # Path for offer
    offer_path = OFFERS_ROOT / "raw" / f"{job_id}.md"
...
def command_render(job_id: str):
    instance_dir = INSTANCES_ROOT / job_id
    web_dir = WEB_ROOT
