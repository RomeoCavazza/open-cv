...
- [blueprint.md](blueprint.md) : Référence de l'architecture hexagonale, du pipeline RAG, de l'infrastructure de données et de la roadmap de hardening.
...
- [data_management.md](data_management.md) : Gestion de la base locale, reset, seeding profil et offres.

---
*Dernière mise à jour : 2026-05-10 (Audit & Hardening)*
