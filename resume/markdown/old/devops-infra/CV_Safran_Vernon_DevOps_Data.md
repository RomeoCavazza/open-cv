Romeo CAVAZZA
Alternance — Ingénieur DevOps / Data & Cloud

Étudiant en Master Cloud et attiré par les environnements industriels de pointe, je souhaite mettre mes compétences DevOps, data et automatisation au service des plateformes techniques de Safran à Vernon.
...
Pré-MSc — Python, APIs, Java OOP, Docker, Linux et GitOps
HarvardX, edX
...
Langages & scripting
Python, Bash, SQL, Lua, C
Cloud & conteneurs
Docker, Kubernetes, Linux, AWS, NixOS
Data Engineering
PostgreSQL, InfluxDB, Grafana, Redis, SQLAlchemy
Observabilité
Grafana, Prometheus, Loki, Git, GitHub Actions
CI/CD & sécurité
GitLab, Jenkins, Docker, SOPS, Valgrind
