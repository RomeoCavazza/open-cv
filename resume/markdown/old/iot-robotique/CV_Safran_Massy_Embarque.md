Romeo CAVAZZA
Alternance — Ingénieur Développement Logiciel Embarqué

Étudiant en Master Robotique & IoT, je souhaite contribuer au développement de logiciels embarqués robustes pour des systèmes critiques en environnement industriel exigeant.
...
Master of Science – Robotique & IoT
EPITECH, Paris, France (2025 – 2026)
Pré-MSc — C, Python, Linux, algorithmique et systèmes
HarvardX, edX
...
C, C++, Python, Bash, SQL
Linux & embarqué
Linux, Git, GDB, Valgrind, Systemd
Instrumentation
Arduino, I2C, UART, USB, InfluxDB
Qualité logicielle
Git, Docker, Pytest, CMake, Grafana
Tooling
FastAPI, PostgreSQL, GitHub Actions, NixOS, Bash
