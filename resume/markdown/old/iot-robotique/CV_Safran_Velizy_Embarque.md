Romeo CAVAZZA
Alternance — Développeur Logiciel Embarqué

Étudiant en Master Robotique & IoT, je souhaite participer au cycle de développement de logiciels embarqués critiques, de la spécification aux tests sur cible.
...
C, C++, Python, Bash, SQL
Embarqué
Linux, Git, GDB, Valgrind, CMake
Instrumentation
Arduino, I2C, UART, USB, InfluxDB
Tests & qualité
Pytest, Docker, GitHub Actions, Grafana, Git
Système
Systemd, NixOS, Bash, FastAPI, PostgreSQL
